...
namespace GeoCoordTool.ViewModels
{
    public sealed class MainViewModel : ObservableObject
    {
        ...
        private readonly CoordinateService _coordinateService = new CoordinateService();
        private readonly MapSheetService _mapSheetService = new MapSheetService();

        private List<CoordinatePoint> _points = new List<CoordinatePoint>();
        ...
        private void ValidateBeforeProcess()
        {
            ...
            if (ProjectionDigits < 0 || ProjectionDigits > 10 || GeoDigits < 0 || GeoDigits > 12)
            {
